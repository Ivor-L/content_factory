...
function normalizeStats(payload: Record<string, unknown>) {
  return {
    likes: pickMetric(payload, [
      ...
      'note_card.interactInfo.likedCount',
      ...
      'data.noteCard.interactInfo.likedCount',
    ...
    collects: pickMetric(payload, [
      ...
      'noteCard.interactInfo.collectedCount',
      'noteCard.interact_info.collected_count',
      'note_card.interactInfo.collectedCount',
      ...
      'data.noteCard.interactInfo.collectedCount',
    ...
    comments: pickMetric(payload, [
      ...
      'noteCard.interactInfo.commentCount',
      'noteCard.interact_info.comment_count',
      'note_card.interactInfo.commentCount',
      ...
      'data.noteCard.interactInfo.commentCount',
    ...
    shares: pickMetric(payload, [
      ...
      'noteCard.interactInfo.shareCount',
      'noteCard.interact_info.share_count',
      'note_card.interactInfo.shareCount',
      ...
      'data.noteCard.interactInfo.shareCount',
...
export async function POST(request: NextRequest) {
  ...
  const payload = parseObject(detail) || detail?.data || {};
  ...
  const mediaCandidates = normalizeUrls([
    ...
    ...collectUrls(payload['poster']),
    ...collectUrls(payload['posterUrl']),
    ...collectUrls(payload['poster_url']),
    ...collectUrls(payload['displayUrl']),
    ...collectUrls(payload['display_url']),
    ...
    ...collectUrls(getByPath(payload, 'note.poster')),
    ...collectUrls(getByPath(payload, 'note.posterUrl')),
    ...collectUrls(getByPath(payload, 'note.poster_url')),
    ...collectUrls(getByPath(payload, 'note.displayUrl')),
    ...collectUrls(getByPath(payload, 'note.display_url')),
    ...
    ...collectUrls(getByPath(payload, 'data.poster')),
    ...collectUrls(getByPath(payload, 'data.posterUrl')),
    ...collectUrls(getByPath(payload, 'data.poster_url')),
    ...collectUrls(getByPath(payload, 'data.displayUrl')),
    ...collectUrls(getByPath(payload, 'data.display_url')),
  ...
  const coverUrl = pickUrlAtPaths(payload, [
    ...
    'note.poster',
    'note.poster.url',
    'note.poster.urlDefault',
    'note.poster.url_default',
    ...
    'data.poster',
    'data.poster.url',
    'data.poster.urlDefault',
    'data.poster.url_default',
