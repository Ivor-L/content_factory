...
try:
    ...
    input_path = workflows_dir / "workflow_xNY4qhKT2cwXYi0v.json"
    with input_path.open('r', encoding='utf-8') as f:
        workflow = json.load(f)
except FileNotFoundError:
    print("Error: workflow_xNY4qhKT2cwXYi0v.json not found in workflows/exports.")
    sys.exit(1)
...
# 4. Save
output_path = workflows_dir / "workflow_xNY4qhKT2cwXYi0v_fixed.json"
with output_path.open('w', encoding='utf-8') as f:
    json.dump(workflow, f, indent=2)

print("Fixed workflow connections saved to workflows/exports/workflow_xNY4qhKT2cwXYi0v_fixed.json")
