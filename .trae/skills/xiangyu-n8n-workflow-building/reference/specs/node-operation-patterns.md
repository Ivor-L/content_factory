...
| Node | Key Config | Reference |
|------|-----------|-----------|
| SplitInBatches | batchSize, options.reset: false | `orchestration-patterns.md` → Section 1 |
| SplitOut | fieldToSplitOut, include | `orchestration-patterns.md` → Section 1 |
| Aggregate | aggregate, destinationFieldName | `orchestration-patterns.md` → Section 1 |
| Wait | resume: "timeInterval", amount, unit | `orchestration-patterns.md` → Section 2 |
| Execute Workflow | workflowId, waitForSubWorkflow | `orchestration-patterns.md` → Section 3 |

**Related Files**:
- **[SKILL.md](SKILL.md)** - Configuration workflow and philosophy
- **[DEPENDENCIES.md](DEPENDENCIES.md)** - Property dependency rules
- **[orchestration-patterns.md](../patterns/orchestration-patterns.md)** - Batch, polling, sub-workflow patterns
- **[workflow-conventions.md](workflow-conventions.md)** - Parameter container, naming, StickyNote conventions
