...
## ⚠️ n8n 2.0 Breaking Change

n8n 2.0 移除了内置 Pyodide，Python Code 节点需配置 Task Runner 才能执行。如果 Python 代码完全无法运行（而非单个错误），请先检查 Task Runner 配置。详见 `code-python.md` 顶部说明。
