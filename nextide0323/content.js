    ...
    const syncItems = async (items) => {
      ...
      for (let index = 0; index < batches.length; index++) {
        ...
        try {
          ...
          showError("同步请求错误: " + e.message + batchLabel);
          return false;
        }
      }
      return true;
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-h-0 bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.02)] rounded-t-[32px] mt-2 border-t border-gray-100", children: [
          ...
          currentItems.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-t border-gray-100 bg-gray-50/50 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `w-full font-bold py-3 rounded-2xl shadow-xl flex items-center justify-center gap-2 transition-all transform ${isCollecting || isSyncing ? "bg-gray-300 cursor-not-allowed opacity-50 text-gray-500" : "bg-blue-600 hover:bg-blue-700 text-white hover:-translate-y-0.5 active:translate-y-0"}`,
